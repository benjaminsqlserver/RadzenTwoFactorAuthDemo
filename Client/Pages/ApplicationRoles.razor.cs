...
namespace HouseholdAppliancesApp.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<HouseholdAppliancesApp.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(HouseholdAppliancesApp.Server.Models.ApplicationRole role)
        {
            try
            {
