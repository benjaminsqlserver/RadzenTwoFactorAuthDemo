...
namespace HouseholdAppliancesApp.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<HouseholdAppliancesApp.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<HouseholdAppliancesApp.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(HouseholdAppliancesApp.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(HouseholdAppliancesApp.Server.Models.ApplicationUser user)
        {
            try
            {
